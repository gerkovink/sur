...
::: callout-note
## Lesstof
De volgende stof moet voor het college bestudeerd zijn:
...
2. Download the "Practical 1: template file" and save it in a new folder with name "RCourse", for example.
