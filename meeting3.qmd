...
Be sure to place the data set [`msleep.csv`](documents/mt3/msleep.csv) in **the same folder as the R Markdown template you are working on**. Use the function `read_csv` from the `readr` package to import the data and save it as `msleep` (using the assignment `<-` operator).
...
# 5 mammals sleep more than 18 hours.
```
